...
```bash
# macOS
cat ~/Library/Application\ Support/axme/scenario-agents.json | grep -A2 compliance-checker-demo

# Linux
cat ~/.config/axme/scenario-agents.json | grep -A2 compliance-checker-demo
```
